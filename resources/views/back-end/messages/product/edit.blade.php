    ...
    <div class="modal-dialog" style="max-width: 80%;">
      <div class="modal-content">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" id="image-edit" class="image form-control" multiple name="image[]" >
        ...
        <div class="modal-footer">
          ...
          <button onclick="updateProduct('.formUpdateProduct')" type="button" class="btn btn-primary">Update</button>
        </div>
      </div>
    </div>
 </div>
